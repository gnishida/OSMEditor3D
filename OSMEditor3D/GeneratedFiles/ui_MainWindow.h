...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        actionPropertyWindow = new QAction(MainWindow);
        actionPropertyWindow->setObjectName(QStringLiteral("actionPropertyWindow"));
        actionNew = new QAction(MainWindow);
        actionNew->setObjectName(QStringLiteral("actionNew"));
        QIcon icon5;
        icon5.addFile(QStringLiteral("Resources/new.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        menuView->addAction(actionPropertyWindow);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        actionPropertyWindow->setText(QApplication::translate("MainWindow", "Property Window", 0));
